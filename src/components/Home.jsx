...
function Home() {
  ...
  return (
    <div className='h-96 p-4 w-80 flex items-center justify-center relative bg-slate-600/50 opacity-80 rounded-2xl shadow-5xl border border-b-0 border-r-0 border-opacity-10'>
